...
return [
    ...
    'credentials' => [//INFORME AS CREDENCIAIS PADRÕES DE SUA LOJA, MAS PORDERÁ SER ALTERADA EM RUNTIME
        'email' => 'new_dan08@hotmail.com',
        //'token' => '3F5B82B9B36644B58AE9A64B597BC32D', //produção
        'token' => '3A7B15323F1D41E2B6C7204F7AAFBD80', //sandbox
    ],
    ...
    'routes' => [
        ...
        'notification' => [
            'callback' => ['PagueSegNotifcController', 'Postnotification'], // Callable callback to Notification function (notificationInfo) : void {}
     ...
     * */
    'host' => [
        //'production' => 'https://ws.pagseguro.uol.com.br', //produção -link oficial de pagamento
        'production' => 'https://ws.sandbox.pagseguro.uol.com.br', //sandbox - link de teste
    ],
    'url' => [
