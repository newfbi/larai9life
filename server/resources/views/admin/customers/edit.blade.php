            ...
            <form action="{{ route('admin.customers.update', $customer->id) }}" method="post" class="form">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" placeholder="Nome" class="form-control" value="{!! $customer->name ?: old('name')  !!}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control">
                            <option value="0" @if($customer->status == 0) selected="selected" @endif>Habilitar</option>
                            <option value="1" @if($customer->status == 1) selected="selected" @endif>Desabilitar</option>
                        </select>
                    </div>
                </div>
                <!-- /.box-body -->
