            ...
            <form action="{{ route('admin.categories.store') }}" method="post" class="form" enctype="multipart/form-data">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="parent">Categoria Relacionada</label>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control ckeditor" name="description" id="description" rows="5" placeholder="Ensira uma descrição">{{ old('description') }}</textarea>
                    </div>
                    <div class="form-group">
