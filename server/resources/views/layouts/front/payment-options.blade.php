@if(isset($payment['name']) && $payment['name'] == 'stripe')
    <tr>
        <td>
            ...
            @else
                <p class="alert alert-danger">Você precisa ter <strong>nome</strong> da chave na sua configuração</p>
            @endif
        </td>
        <td>
    ...
    <tr>
        ...
        <td>
            <form action="{{ route('checkout.store') }}" method="post">
                ...
                <input type="hidden" class="delivery_address_id" name="delivery_address" value="">
                <input type="hidden" class="courier_id" name="courier" value="">
                <button type="submit" class="btn btn-success pull-right">Pague com PayPal <i class="fa fa-paypal"></i></button>
            </form>
        </td>
    </tr>
@endif
